...
public class PdfUtil {
    ...
    public static void closeStream(BufferedInputStream bis,FileOutputStream fos,BufferedOutputStream bos){
        try {
            if(bis!=null){
                bis.close();
            }
    ...
    public static void main(String[] args) {
        File file = new File("G:\\ETC\\ceshi.pdf");
        String bsStr=PDFToBase64(file);
//        Map temp= new HashMap();
//        temp.put("ceshi",bsStr);
//        temp.put("ceshi1",null);
//        bsStr= bsStr.replaceAll("\\n", "");
//        System.out.println("==============================================");
//        base64StringToPdf(s,"G:\\ETC\\2.pdf");
